...
TECHNO_IMG = "https://telegra.ph/file/b118ea810a07493be84a8.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/White_devil_XD_Y0_bot")],
                                                                                   [InlineKeyboardButton(text="ADD WHITEDEVIL BOT TO YOUR GROUP",
        ...
        update.effective_message.reply_text("ZINDHA HU MERE BAHI MERE YARno")
